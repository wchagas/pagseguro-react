	...
	render() {
		...
		return <LoadLibrary env={env}>
			<DirectPayment className="ps-react-direct-payment">
				...
				<Forms>
					{
						!hiddenSenderForm && active == 'sender' &&
						<Sender onChange={this.onChange.bind(this, 'sender')} onChangeStep={this.onChangeStep.bind(this)} data={sender} steps={steps} />
					}

					{
						!hiddenShippingForm && active == 'shipping' &&
						<Shipping onChange={this.onChange.bind(this, 'shipping')} onChangeStep={this.onChangeStep.bind(this)} data={shipping} steps={steps} />
					}

					{
						!hiddenBillingForm && active == 'billing' &&
						<Billing onChange={this.onChange.bind(this, 'billing')} onChangeStep={this.onChangeStep.bind(this)} data={billing} steps={steps} shipping={shipping || false} />
					}
